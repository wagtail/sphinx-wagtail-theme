...
intersphinx_mapping['t3tssyntax'] = ('http://docs.typo3.org/typo3cms/TyposcriptSyntaxReference', None)


html_theme_options = {
    'github_repository': 'TYPO3-Documentation/TYPO3CMS-Reference-Typoscript',
    'github_branch': 'latest'
}
latex_documents = [(
    'Index',
    't3tsref.tex',
    u'TypoScript Reference',
...
html_use_opensearch = 'http://docs.typo3.org/typo3cms/TyposcriptReference/0.0/'
